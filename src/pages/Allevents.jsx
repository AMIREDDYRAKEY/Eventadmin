        ...
        <div className='min-h-screen w-full relative'>
            <div className='w-full px-4 md:px-8 pt-8'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 justify-items-center'>
                        ...
                        <div  className='bg-[#292b48] flex flex-col pb-5 w-full max-w-[280px] rounded-lg hover:scale-105 transition-transform duration-300'>
                            <div>
                                <img src={data.image} alt={data.Eventname} className='w-full h-[240px] object-cover rounded-t-lg' />
                            </div>
                            <div className='flex flex-col px-4 mt-4'>
                                <h3 className='text-xl text-[#74779a] font-semibold'>{data.Eventname}</h3>
                                <p className='text-lg text-[#74779a] font-semibold mt-2'>{data.Date}</p>
                            </div>
