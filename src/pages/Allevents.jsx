...
const Allevents = () => {
  ...
  return (
    <div className='pb-[40px] '>
        <div className='min-h-screen h-full'><Layout/></div>
        <div className=' md:mt-[-45%] mt-[-600px]'> 
            {/* <div className=''> <button className='text-[#98a2cb] bg-[#292b48] px-5 py-2 md:ml-[30px] ml-4  rounded-lg font-semibold ' onClick={()=>navigate('/')}>Back</button></div> */}
        <h3 className='text-[#74779a] md:ml-[200px] font-bold text-3xl text-center'>All Events</h3></div>
    <div className='md:grid md:grid-cols-3 grid grid-cols-1 md:ml-[200px] gap-10 md:px-[140px]  ml-5 mt-[50px]'>
        {
