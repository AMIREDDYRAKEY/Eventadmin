  ...
  return (
    <div className='flex items-center justify-center  z-0'>
         <form action="" className=' pb-[20px] px-3 shadow-lg shadow-[#161720] bg-[#292b48] rounded-lg flex flex-col gap-4 w-[300px] mt-[20px]'>
            ...
            <div className='text-[#98a2cb] text-end text-2xl mt-[-60px]'> <button onClick={()=>setsubmit(submit)}><IoClose /></button></div>
            {/* inputs */}
           <div className="flex flex-col gap-4 overflow-y-auto pt-[20px]">
                {/* sno */}
                ...
                {/* Idno */}
                               <div className='flex flex-col '>
                    <input type="text" placeholder='Enter Idno' value={Idno} className='py-2 px-3 text-white md:w-[270px] bg-[#1b1f38] rounded-lg' onChange={(e)=>setIdno(e.target.value)}/>
                <span className='text-red-600 ml-[5px] font-semibold'>{errors.Idno}</span>
                </div>
                {/* section */}
                    <div className='flex flex-col '>
                    {/* <input type="text" placeholder='Enter Section' value={section} className='py-2 px-3 text-white md:w-[270px] bg-[#1b1f38] rounded-lg' onChange={(e)=>setsection(e.target.value)}/> */}
                {/* <span className='text-red-600 ml-[5px] font-semibold'>{errors.section}</span> */}
                <select name="" id="" className='py-2 px-3 text-[#98a2cb] md:w-[270px] bg-[#1b1f38] rounded-lg'>
